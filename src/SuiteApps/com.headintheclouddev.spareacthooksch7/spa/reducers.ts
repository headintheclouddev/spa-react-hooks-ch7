...
function postsReducer(state: IPostProps[], action: { type?: string, title: string, content: string, author: string, id: number, posts: IPostProps[] }) {
...
export default function appReducer(state: { user: string, posts: IPostProps[], error: string }, action: { type?: string, title: string, content: string, author: string, id: number, username: string, posts: IPostProps[] }) {
